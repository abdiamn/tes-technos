                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6 lg:gap-8">
                        <a href="#" class="scale-100 p-6 bg-white dark:bg-gray-800/50 dark:bg-gradient-to-bl from-gray-700/50 via-transparent dark:ring-1 dark:ring-inset dark:ring-white/5 rounded-lg shadow-2xl shadow-gray-500/20 dark:shadow-none flex motion-safe:hover:scale-[1.01] transition-all duration-250 focus:outline focus:outline-2 focus:outline-red-500">
                            <div>
                                ...
                                <h2 class="mt-6 text-xl font-semibold text-gray-900 dark:text-white">DEV TEST</h2>
                                <div class="dark:text-white">
                                    <p>Tes ini ditujukan untuk mengetahui seberapa cepat kandidat dapat belajar dan melakukan problem solving.</p>
                                    <hr>
                                    <h2 class="mt-6 text-xl font-semibold text-gray-900 dark:text-white" style="margin-top: 100px">Test 1</h2>
                                    <code>
                                        <b>Problem : </b><br>
                                    ...
                                    <h2 class="mt-6 text-xl font-semibold text-gray-900 dark:text-white" style="margin-top: 100px">Test 2</h2>
                                    <code>
                                        <b>Problem : </b><br>
                                    ...
                                    <h2 class="mt-6 text-xl font-semibold text-gray-900 dark:text-white" style="margin-top: 100px">Test 3</h2>
                                    <code>
                                        <b>Problem : </b><br>
                                        MVC:<br>
